 ...
 *  2. C++ 11 introduced rvalue refernce.
 *  
 *  Simolified Definition:
...
foo() = 50;  // So foo() is return lvalue and it will compile
...
/
 *
 * Misconception 3 : lvalues are modifiable.    
 */
 ...
 *  Summary  
 *  
 *  1. Every C++ expression yied either an rvalue or a lvalue.
